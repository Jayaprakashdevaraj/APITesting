...
Scenario Outline: validate user should create new recored in incident table 
And user should set header key as "Content-Type" and value as "application/json"
And user should give short description as "<shortDescrition>"
When user hit the post method to create new record in incident table
Then user should get success responce with following expected values
|statusCode | statusLine | responseFormat |
|201		|Created	 |JSON			  |
And user should see the "<shortDescrition>" value in short_description key
